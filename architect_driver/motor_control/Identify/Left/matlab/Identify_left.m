...
load('Identify_left.mat');

% ------ ステップ同定 ------
% 実験時の目標値
wheel_diameter = 0.38695;
...
xlim([0, 100]);
xlabel('rotation [rad/s]', 'FontSize', 15, 'Interpreter', 'Latex');
ylabel('step [steps]', 'FontSize', 15, 'Interpreter', 'Latex');
% % ------ 結果のプロット終了 ------